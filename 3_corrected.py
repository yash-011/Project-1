        ...
        for box in boxes:
            ...
            if inside_zone >= 0:
                ...
                if (
                    ...
                    img_filename = (
                        f"ALERT_ID_{track_id}_{violation_reason}_"
                        f"{timestamp_str}.jpg"
                    )
                    ...
                    snapshot = clean_frame_copy.copy()
                    ...
                    cv2.putText(
                        ...
                        (x1, min(snapshot.shape[0] - 10, y2 + 25)),
                        cv2.FONT_HERSHEY_SIMPLEX,
                        0.6,
                        (0, 0, 255),
                        2
                    ...
                    cv2.putText(
                        snapshot,
                        f"Speed: {target_speed_kmph:.1f} km/h",
                        (x1, min(snapshot.shape[0] - 10, y2 + 50)),
                        cv2.FONT_HERSHEY_SIMPLEX,
                        0.6,
                        (0, 0, 255),
                        2
                    ...
                    cv2.putText(
                        snapshot,
                        f"Plate: {plate_text}",
                        (x1, min(snapshot.shape[0] - 10, y2 + 75)),
                        cv2.FONT_HERSHEY_SIMPLEX,
                        0.6,
                        (0, 255, 255),
                        2
